...
class ClimateFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        setupSeatButtons(seatLeftButtons)  { level -> CoroutineScope(Dispatchers.IO).launch { EVHardware.setSeatHeatLeft(level) } }
        setupSeatButtons(seatRightButtons) { level -> CoroutineScope(Dispatchers.IO).launch { EVHardware.setSeatHeatRight(level) } }
    }
